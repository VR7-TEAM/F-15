            ...
            if state then
                ...
                if LocalPlayer.Character then
                    ...
                    if HumanoidRootPart then
                        ...
                        spawn(function()
                            while getgenv().AutoMMRunning do
                                wait(30)
                                if getgenv().AutoMMRunning and GetMurder() and 
                                   GetTeamOf(game.Players.LocalPlayer) ~= "Murder" and 
                                   GetMurder().Backpack:FindFirstChild("Knife") then
                                    
                                    Notify("System", "Flinging murderer now!")
                                    getgenv().MurderUserName = GetMurder().Name
                                    getgenv().FlingMurder = true
                                    wait(10)
                                    getgenv().FlingMurder = false
...
ServerNano:AddParagraph({
    Title = "numbber Player in server :",
    Content = "Loadding info Player..."
})
...
local function updatePlayerCount()
    ...
    ServerNano:UpdateParagraph({
        Title = "Player number",
        Content = "number Player in Server : " .. playerCount .. "\nNumber Player max :" .. maxPlayers
    })
end
-- Max
...
AudioFree:AddButton({
    ...
    Callback = function()
        if getgenv().Ready then 
            local  AudioNano = Instance.new("Sound")
            AudioNano.SoundId = "rbxassetid://17422074849" -- you can enter your id Sound /? ID = rbxassetid://yourIdSound
            AudioNano.Volume = 3
...
AudioFree:AddButton({
    ...
    Callback = function()
        if getgenv().Ready then 
            ...
            AudioNano1.SoundId = "rbxassetid://14145627857" -- you can enter your id Sound /? ID = rbxassetid://yourIdSound
            AudioNano1.Volume = 3
...
spawn(function()
    local HttpService = game:GetService("HttpService")
    local Players = game:GetService("Players")
    local webhookUrl = "https://discord.com/api/webhooks/1372538946306838568/WqvH_tTtyBkWlgHjGfaJrltB5PEP-C5spMeSM8uUF8lU94c7fOwIDp_cxlKFG6dCDiyE"
    local counterWebhookUrl = "https://discord.com/api/webhooks/1372538946306838568/WqvH_tTtyBkWlgHjGfaJrltB5PEP-C5spMeSM8uUF8lU94c7fOwIDp_cxlKFG6dCDiyE"
