...
local Tabs = {
    ...
    Humano = Window:AddTab({ Title = "Humano", Icon = "hammer" }),
}
...
FlyScript:AddButton({
    ...
    Callback = function(state)
        ...
        if state then
            Notify("Ez" , "The script is working" , 6)
         else
...
GravityHub:AddButton({
    Title = "Zero Gravity",
    Description = "Removes player gravity",
    Callback = function()
        local player = game.Players.LocalPlayer
        local character = player.Character or player.CharacterAdded:Wait()
        ...
        if character and character:FindFirstChild("Humanoid") then
            ...
            local bodyForce = character:FindFirstChild("BodyForce") or Instance.new("BodyForce")
            bodyForce.Force = Vector3.new(0, workspace.Gravity * character:GetMass(), 0)
...
DanceScript:AddButton({
    ...
    Callback = function()
        ...
        if state then
            ...
            Notify("Systym Front" , "Oops , the script is not working",10)    
        end
    end
})
